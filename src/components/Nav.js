...
const Nav = (props) => {
    ...
    return (
        <nav className='px-2 flex  h-[65px] w-full items-center justify-between bg-white-0 drop-shadow-[0_1px_10px_rgba(74,74,74,0.07)]' >
            {/* Navbar logo */}
            <div className='flex w-1/3 lg:w-1/5 justify-center'>
            ...
            <div className='w-3/5 '>
                {userStatus.islogedin ? (
                    <div className='flex  items-center'>
                        ...
                        <div className='hidden sm:flex ml-[54px] w-[353px] h-[40px]'>
                            <Search className='flex' width={' md:w-[200px] lg:w-[353px]'} height={'h-[40px]'} />
                        </div>
                    </div>
                ) : <>  </>
                }
            ...
            {/* User login details */}
            <div className='flex items-center w-1/3 lg:w-1/5 justify-center'>
                <img className='rounded-full w-[32px] h-[32px] bg-gray-0 mx-1' src={userStatus.islogedin ? userimage : defaultImage} alt="" />
                <div className='flex items-center'>
                    <label className='hidden md:flex font-display font-normal text-base mx-1'>{userStatus.islogedin === true ? userStatus.user : userName}</label>
